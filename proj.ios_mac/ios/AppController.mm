...
- (BOOL)showScores
{
    ...
    gkController.leaderboardDelegate = viewController;
    gkController.leaderboardIdentifier = kEasyLeaderboardID;
    
    [viewController presentModalViewController:gkController animated:YES];
    return YES;
}
